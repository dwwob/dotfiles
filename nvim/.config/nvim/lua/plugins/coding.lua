...
return {
  ...
  -- =========================================================================
  {
    ...
    opts = {
      ...
      -- FIXED: Uses blink's native internal engine mapped directly to Neovim's runtime
      snippets = {
        preset = "default",
      },
      completion = {
    ...
    -- FIXED: Removed the buggy custom FileType autocommand block entirely.
    -- Blink automatically reads friendly-snippets via the "snippets" source.
